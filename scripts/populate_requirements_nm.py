...
# Step 1: Get the Airtable record ID for FSVP-NM-LMC
...
# Step 2: Requirements for FSVP-NM-LMC
REQUIREMENTS_NM_LMC = [
    # ── FOUNDATION ──────────────────────────────────────────
    ...
    {"Document Name": "Sub-Supplier Verification (Japan)",      "Category": "Supplier Evaluation", "CFR Reference": "21 CFR 1.506(d)(1)(i)",     "Validity Days": 1095},
    # ── VERIFICATION ────────────────────────────────────────
...
def populate(program_code, requirements):
    ...
    for req in requirements:
        req["FSVP Program"] = [program_record_id]  # Airtable expects a list for linked fields
...
populate("FSVP-NM-LMC", REQUIREMENTS_NM_LMC)
